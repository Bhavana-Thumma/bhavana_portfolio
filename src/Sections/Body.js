      ...
      <main class="l-main">
        <section class="home bd-grid" id="home">
          <div class="home__data">
            <h1 class="home__title">
              Hi,
              <br />
              I'm <span class="home__title-color">Bhavana</span>
              <br /> Web Developer
            </h1>
          ...
          <div class="home__social">
            <a
              target="blank"
              href="https://www.linkedin.com/in/bhavanathumma/"
            ...
            <a
              target="blank"
              href="https://github.com/Thumma-Bhavana"
              class="home__social-icon"
            >
          ...
          <div class="home__img">
            ...
            <img src="BhavanaRes.jpg" class="rounded-circle" alt="..." />
          </div>
        </section>
        ...
        <section class="about section " id="about">
          ...
          <div class="about__container bd-grid">
            <div class="about__img">
              <img src="codergirl.jpg" alt="" />
            </div>

            <div>
              <h2 class="about__subtitle">I'm Bhavana</h2>
              <p class="about__text">
                A goal-oriented IT student, seeking to work as a software
                developer in a fast-growing company, where I can apply my
                experience in working on a diverse array of IT projects using my
                language proficiency in Python, Java, JavaScript, React JS,
                DBMS, HTML, CSS.
              </p>
            </div>
          </div>
        ...
        <section class="contact section" id="contact">
          ...
          <div class="contact__container bd-grid">
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSew-EWMO8pu7_l0pbka9jlimPpsAlIvfsU8SGf8TTvwCCFd6Q/viewform?embedded=true"
              width="640"
              height="1099"
              frameborder="0"
              marginheight="0"
